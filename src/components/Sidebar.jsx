...
// const SettingsModal = ({ onClose, onOpenProfile }) => {
//   return (
//     <div className="modal-overlay settings-modal">
//       <div className="modal-content">
//         <div className="modal-header">
...
//   const handleSave = () => {
//     setIsEditing(false);
//     // Ở đây bạn có thể thêm logic để lưu dữ liệu vào backend nếu cần
//     console.log("Profile saved:", profile);
//   };
...
//   const openUserProfileModal = () => {
//     setIsProfileOpen(false); // Đóng modal trước đó
//     setIsSettingsOpen(false); // Đóng modal cài đặt nếu đang mở
//     setIsUserProfileOpen(true);
//   };
